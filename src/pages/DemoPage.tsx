...
import { ChevronRight, Users, Target, CheckCircle, Clock, TrendingUp, Settings, Plus, Eye, MessageSquare, Star, Trophy, Calendar, Bell, BarChart3, Zap } from 'lucide-react';
...
const DemoPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const text = "Just passed my AWS exam with 847/1000! 🎉 The practice tests really helped. Already feeling more confident about cloud architecture discussions in interviews.";
    let index = 0;
