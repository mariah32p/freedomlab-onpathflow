...
import { Target, Users, CheckCircle, Clock, TrendingUp, Trophy, Bell, Settings, Star, MessageSquare, ArrowRight, Play, Zap, Shield, BarChart3, Smartphone, Globe, ChevronDown, Eye } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            <div className="text-center lg:text-left">
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-slate-900 mb-4 md:mb-6 leading-tight">
                Help Your Clients 
              ...
              <p className="text-base sm:text-lg md:text-xl text-slate-600 mb-6 md:mb-8 leading-relaxed max-w-2xl mx-auto lg:mx-0">
              ...
              <div className="flex flex-col items-center lg:items-start">
                <Link 
                  to="/signup" 
                  className="bg-emerald-500 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-semibold text-base sm:text-lg hover:bg-emerald-600 transform hover:scale-105 transition-all duration-200 shadow-lg hover:shadow-xl mb-3"
                >
            ...
            <div className="relative mt-8 lg:mt-0 order-first lg:order-last">
              <div className="bg-white rounded-xl lg:rounded-2xl shadow-2xl border border-slate-200 overflow-hidden transform rotate-1 lg:rotate-2 hover:rotate-0 transition-transform duration-500 max-w-md mx-auto lg:max-w-none">
                {/* Browser Header */}
                <div className="bg-slate-100 px-3 lg:px-4 py-2 lg:py-3 border-b border-slate-200 flex items-center justify-between">
                  <div className="flex items-center space-x-2">
                  ...
                  <div className="text-xs lg:text-sm text-slate-600 hidden sm:block">onpathflow.com</div>
                  <div></div>
                </div>
                
                {/* App Content */}
                <div className="p-4 lg:p-6 bg-gradient-to-br from-slate-50 to-blue-50">
                  <div className="flex items-center justify-between mb-4 lg:mb-6">
                    <div className="flex items-center space-x-3">
                      <div className="w-6 h-6 lg:w-8 lg:h-8 bg-gradient-to-r from-emerald-500 to-blue-600 rounded-lg lg:rounded-xl flex items-center justify-center">
                        <Target className="w-3 h-3 lg:w-5 lg:h-5 text-white" />
                      </div>
                      <div>
                        <h1 className="text-sm lg:text-lg font-bold text-slate-800">OnPathFlow</h1>
                        <span className="text-slate-500 text-xs lg:text-sm hidden sm:block">Dashboard</span>
                      </div>
                    </div>
                    <div className="flex space-x-1 lg:space-x-2">
                      <div className="bg-emerald-500 text-white px-2 lg:px-3 py-1 rounded-md lg:rounded-lg text-xs font-medium">Dashboard</div>
                      <div className="text-slate-600 px-2 lg:px-3 py-1 rounded-md lg:rounded-lg text-xs hidden sm:block">Analytics</div>
                    </div>
                  </div>
                  
                  {/* Mini Stats */}
                  <div className="grid grid-cols-2 gap-3 lg:gap-4 mb-4 lg:mb-6">
                    <div className="bg-white p-3 lg:p-4 rounded-lg lg:rounded-xl shadow-sm">
                      <div className="text-lg lg:text-2xl font-bold text-emerald-600">24</div>
                      <div className="text-xs text-slate-600">Active Goals</div>
                    </div>
                    <div className="bg-white p-3 lg:p-4 rounded-lg lg:rounded-xl shadow-sm">
                      <div className="text-lg lg:text-2xl font-bold text-blue-600">89%</div>
                  ...
                  <div className="space-y-2 lg:space-y-3">
                    <div className="bg-white p-2 lg:p-3 rounded-lg shadow-sm">
                      <div className="flex justify-between text-sm mb-2">
                        <span className="text-slate-700 text-xs lg:text-sm">Weight Loss Journey</span>
                    ...
                    <div className="bg-white p-2 lg:p-3 rounded-lg shadow-sm">
                      <div className="flex justify-between text-sm mb-2">
                        <span className="text-slate-700 text-xs lg:text-sm">Business Launch</span>
              ...
              {/* Floating Elements */}
              <div className="absolute -top-2 lg:-top-4 -right-2 lg:-right-4 bg-emerald-500 text-white p-2 lg:p-3 rounded-lg lg:rounded-xl shadow-lg transform rotate-12">
                <CheckCircle className="w-4 h-4 lg:w-6 lg:h-6" />
              </div>
              <div className="absolute -bottom-2 lg:-bottom-4 -left-2 lg:-left-4 bg-blue-500 text-white p-2 lg:p-3 rounded-lg lg:rounded-xl shadow-lg transform -rotate-12">
