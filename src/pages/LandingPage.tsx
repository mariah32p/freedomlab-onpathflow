...
const LandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="pt-20 pb-32 bg-gradient-to-br from-slate-50 via-blue-50 to-emerald-50 relative overflow-hidden">
            ...
            <div className="relative">
              <div className="bg-white rounded-2xl shadow-2xl border border-slate-200 overflow-hidden transform rotate-2 hover:rotate-0 transition-transform duration-500">
                ...
                <div className="bg-slate-100 px-4 py-3 border-b border-slate-200 flex items-center justify-between">
                  ...
                  <div className="text-sm text-slate-600">onpathflow.com</div>
                  <div></div>
                </div>
                ...
                <div className="p-6 bg-gradient-to-br from-slate-50 to-blue-50">
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <div className="flex space-x-2">
                      <div className="bg-emerald-500 text-white px-3 py-1 rounded-lg text-xs font-medium">Dashboard</div>
                      <div className="text-slate-600 px-3 py-1 rounded-lg text-xs">Analytics</div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-3">
                    <div className="bg-white p-3 rounded-lg shadow-sm">
                      <div className="flex justify-between text-sm mb-2">
                        <span className="text-slate-700">Senior Engineer Path</span>
                    ...
                    <div className="bg-white p-3 rounded-lg shadow-sm">
                      <div className="flex justify-between text-sm mb-2">
                        <span className="text-slate-700">AWS Certification</span>
